...
export const usersOnboardingStatusStrings = {
  ...
  containsStatusInLogsLabel: "El log contiene el estado seleccionado",
  ...
  statusChartOpen: "View status chart",
  statusChartDialogTitle: "Onboarding status chart",
  logStatusStatsChartOpen: "View log stats chart",
  logStatusStatsChartDialogTitle: "Onboarding log status stats",
  logStatusStatsBarLabel: "Records",
  logStatusStatsTotalRecords: (count: number) => `Total records in range: ${count}`,
  statusWithoutLogs: "Sin estado en logs",
